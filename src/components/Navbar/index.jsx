...
const LogoDarkMode = (props) => {
    return (
        <img
            src="https://res.cloudinary.com/di1hmzv5y/image/upload/v1704637535/LOGOISABLACK_u7la0z.png"
            alt="ISA LOGO"
            {...props}
        />
    );
...
const LogoLightMode = (props) => {
    return (
        <img
            src="https://res.cloudinary.com/di1hmzv5y/image/upload/v1704637053/ISALOGO-removebg-preview_xyv1vc.png"
            alt="ISA LOGO"
            {...props}
        />
    );
