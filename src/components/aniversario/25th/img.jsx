...
import { navbarOptions25th } from "../../../config/configaniversario/25thaniversario/25thconfig";
  ...
  return (
    <>
      <div className="bg-slate-200 dark:bg-gray-800 h-full py-6 sm:py-8 lg:py-12">
        {navbarOptions25th
          .filter((option) => option.dropDown && option.dropDownOptions25th)
          .map((option) =>
            option.dropDownOptions25th.map((dropDownOption25th) => (
              <div
                className="mx-auto max-w-screen-2xl px-4 md:px-8"
                key={dropDownOption25th.imageUrl}
              >
                <div className="mb-4 flex text-center items-center justify-between gap-8 sm:mb-8 md:mb-12">
                  ...
                  <div className="mt-3 sm:mt-5 sm:ml-8">
                    <a
                      href={dropDownOption25th.regresar}
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-3 md:gap-6 xl:gap-8">
                  <div
                      ...
                      onClick={() => openOverlay(dropDownOption25th.imageUrl)}
                  >
                    <img
                      src={dropDownOption25th.imageUrl}
                  ...
                  <div
                    onClick={() => openOverlay(dropDownOption25th.imageUrl2)}
                    class="group relative flex  h-52 rounded-2xl bg-gray-100 shadow-lg md:col-span-2 md:h-[500px] md:w-[745px]">
       
                    <img
                      src={dropDownOption25th.imageUrl2}
                      loading="lazy"
                  ...
                  <div
                    onClick={() => openOverlay(dropDownOption25th.imageUrl3)}
                    class="group relative flex  h-52 rounded-2xl bg-gray-100 shadow-lg md:col-span-2 md:h-[500px] md:w-[745px]">
          
                    <img
                      src={dropDownOption25th.imageUrl3}
                      loading="lazy"
