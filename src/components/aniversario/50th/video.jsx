...
const Img = () => {
    ...
    return (
        <div className=" h-full py-6 sm:py-8 lg:py-12 ">
            {navbarOptions50thv
                .filter(
                    (option) => option.dropDown && option.dropDownOptions50thv
                )
                .map((option) =>
                    option.dropDownOptions50thv.map(
                        (dropDownOption50thv, index) => (
                                ...
                                <div className="mb-4 md:flex md:text-center md:items-center md:justify-between md:gap-8 sm:mb-8 md:mb-12">
                                    ...
                                    <div className="mt-3 sm:mt-5 sm:ml-8 flex gap-1 mb md:flex ">
                                        <div className="mb-1">
                                            <a
                                                href={
                                                    dropDownOption50thv.aniversario
                                                }
