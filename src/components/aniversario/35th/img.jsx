        ...
        <>
            <div className=" h-full py-6 sm:py-8 lg:py-12">
                {navbarOptions35th
                    .filter(
                        (option) =>
                            option.dropDown && option.dropDownOptions35th
                    )
                    .map((option) =>
