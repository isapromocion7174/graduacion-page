        ...
        <>
            <div className=" h-full py-6 sm:py-8 lg:py-12">
                {navbarOptions42th
                    .filter(
                        (option) =>
                            option.dropDown && option.dropDownOptions42th
                    )
                    .map((option) =>
